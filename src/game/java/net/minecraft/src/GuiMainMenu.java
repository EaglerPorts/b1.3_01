...
public class GuiMainMenu extends GuiScreen {
	...
	public void initGui() {
		...
		if(false) {
			...
			this.controlList.add(b = new GuiButton(0, this.width / 2 - 100, var4 + 72, 98, 20, var2.translateKey("menu.options")));
			this.controlList.add(b = new GuiButton(4, this.width / 2 + 2, var4 + 72, 98, 20, I18n.format("github")));
		}
	...
	protected void actionPerformed(GuiButton var1) {
		...
		if(var1.id == 2) {
			...
			else this.mc.displayGuiScreen(new GuiScreenInfo(this, new TextLine("notAdded", 0xFFCCCC, I18n.format("menu.multiplayer")), new TextLine(""), new TextLine("willAdd", 0x888888)));
		}
