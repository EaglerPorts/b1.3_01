...
public class GuiMainMenu extends GuiScreen {
	...
	public void initGui() {
		...
		if(false) {
			...
			this.controlList.add(b = new GuiButton(0, this.width / 2 - 100, var4 + 72 + 12, 98, 20, var2.translateKey("menu.options")));
			this.controlList.add(b = new GuiButton(4, this.width / 2 + 2, var4 + 72 + 12, 98, 20, var2.translateKey("eaglercraft.github")));
		}
