...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
		...
		if(this.mc.gameSettings.showDebugInfo) {
			...
			if (this.mc.gameSettings.showFramerate) var8.drawStringWithShadow("Minecraft Beta 1.3_01 (" + this.mc.fps + " fps)", 2, 2, 16777215);
			else var8.drawStringWithShadow("Minecraft Beta 1.3_01", 2, 2, 16777215);
